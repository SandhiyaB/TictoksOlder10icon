...
class IndividualLeaveHistory1 extends Component {
...
var companyId = CryptoJS.AES.decrypt(localStorage.getItem('CompanyId'), "shinchanbaby").toString(CryptoJS.enc.Utf8)
    ...
    $.ajax({
     ...
     // url: "https://wildfly.tictoks.com:443/EmployeeAttendenceAPI/EmployeeReport/employeeIndividualAttendanceDailyReport",
       ...
       url: "https://wildfly.tictoks.com:443/EmployeeAttendenceAPI/employeeleaverequest/IndividualLeaveHistory",
...
LeaveHistory(){
 ...
 <h3 className="centerAlign" style={{ textAlign: "center" }}>Individual Leave History For The Year {this.state.year} </h3>
...
export default IndividualLeaveHistory1;
